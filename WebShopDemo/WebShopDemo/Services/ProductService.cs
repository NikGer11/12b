...
namespace WebShopDemo.Services
{
    public class ProductService : IProductService
    {
        ...
        public bool Create(string name, int brandId, int categoryId, string picture, int quantity, decimal price, decimal discount)
        {
            ...
            {
                ProductName = name,
                Brand = _context.Brands.Find(categoryId),
        ...
        public List<Product> GetProducts(string searchStringCategoryName, string searchStringBrandName)
        {
            ...
            {
                products = products.Where(x => x.Category.CategoryName.ToLower().Contains(searchStringBrandName.ToLower())
        ...
        public bool Uptade(int productId, string name, int brandId, int categoryId, string picture,
            int quantity, decimal price, decimal discount)
        {
            var product = GetProductById(productId);
            if (product == default(Product))
